...
#
# Description: Install luci-app-amlogic plugin for OpenWrt on Amlogic
#
...
query_version() {
    ...
    curl -s "https://api.github.com/repos/lasthinker/luci-app-amlogic/releases" >${github_api_file}
    sleep 1
...
download_plugin() {
    ...
    plugin_url="https://github.com/lasthinker/luci-app-amlogic/releases/download"
