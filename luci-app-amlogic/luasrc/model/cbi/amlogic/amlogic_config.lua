...
local des_content = des_content .. "<br />" .. translate("Tips: The amlogic SoC (E.g: s905x) and mainline version of the kernel (E.g: 5.10) will automatically match the current openwrt firmware.")
...
firmware_repo.default = "https://github.com/lasthinker/amlogic-s9xxx-openwrt"
...
kernel_path.default = "https://github.com/lasthinker/flippy-kernel/tree/main/library"
