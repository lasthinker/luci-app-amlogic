...
local des_content = des_content .. "<br />" .. translate("Tips: The amlogic SoC (E.g: s905x) and mainline version of the kernel (E.g: 5.4) will automatically match the current openwrt firmware.")
